# sdkwork-comments-engagement-repository-sqlx

Domain: comments
Capability: comments-engagement
Package type: rust-crate
Status: ready

This README is the SDKWork module entrypoint for `sdkwork-comments-engagement-repository-sqlx`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../sdkwork-specs/`.
...
- `cargo test -p sdkwork-comments-engagement-repository-sqlx`
