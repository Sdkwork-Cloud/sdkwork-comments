# sdkwork_comments_storage_sqlx

Domain: communication
Capability: comments-storage
Package type: rust-crate
Status: ready

This README is the SDKWork module entrypoint for `sdkwork_comments_storage_sqlx`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.

## Public API

- `comments_storage_capability_manifest`
...
- `cargo test --manifest-path packages/native-rust/comments/sdkwork-comments-storage-sqlx-rust/Cargo.toml`
