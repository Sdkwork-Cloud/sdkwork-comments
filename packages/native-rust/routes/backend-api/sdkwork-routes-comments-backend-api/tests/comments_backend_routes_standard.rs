use sdkwork_routes_comments_backend_api::{
    comments_backend_api_manifest, COMMENTS_BACKEND_API_AUTH_MODE, COMMENTS_BACKEND_API_AUTHORITY,
...
fn comments_backend_api_routes_use_backend_prefix_and_dual_token_auth() {
    ...
    for route in &manifest.routes {
        ...
        assert_eq!(route.ownership_api_authority, COMMENTS_BACKEND_API_AUTHORITY);
        assert_eq!(route.source_route_crate, "sdkwork-routes-comments-backend-api");
    }
