...
ALTER TABLE comments_thread ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE comments_comment ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE comments_comment_projection ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE comments_reaction ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE comments_engagement_reaction ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE comments_engagement_favorite ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE comments_engagement_visit_history ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE comments_engagement_projection ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE comments_moderation_case ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE comments_moderation_event ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
