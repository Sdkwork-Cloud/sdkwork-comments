...
```bash
npm install @sdkwork/comments-app-sdk
# or
yarn add @sdkwork/comments-app-sdk
# or
pnpm add @sdkwork/comments-app-sdk
```

## Quick Start

```typescript
import { SdkworkAppClient } from '@sdkwork/comments-app-sdk';
...
const threadId = '1';
const result = await client.comments.threads.retrieve(threadId);
```
...
```typescript
import { SdkworkAppClient, NetworkError, TimeoutError, AuthenticationError } from '@sdkwork/comments-app-sdk';
